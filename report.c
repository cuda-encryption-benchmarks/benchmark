...
exception_t* report_write_system_information(report_t* report) {
	...
	fprintf(report->file, "\\section{System Information} \
		System information is generated by running the \\verb'lshw' command and is stored in the ``hardware.txt'' file. \
		If the \\verb'lshw' command is not installed then, obviously, no system information will be generated. \
