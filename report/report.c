...
exception_t* report_write_system_information(report_t* report) {
	...
	fprintf(report->file, "\\section{System Information} \
		The following system information was generated by running the lshw command. \
		If the lshw command was not installed then, obviously, no system information was generated. \
		Note that running the lshw command as root will generate the most information, \
		and should be preferred to running lshw as a regular user.\n\n");
