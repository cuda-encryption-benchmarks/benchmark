...
/*!	\brief Analyze the individual runs within the structure and set its members appropriately.
 *
...
/*!	\brief Initialize the specified benchmark_data_t.
 *
 *	\return	NULL on success, exception_t* on failure.
 */
...
/*!	\brief Free the specified benchmark_data_t.
 *
 *	\return	NULL on success, exception_t* on failure.
 */
